...
export class CreateUserDto {
  @ApiPropertyOptional({ description: 'User role', enum: Role, example: Role.USER, default: Role.USER })
  @IsEnum(Role)
  @IsOptional()
  role?: Role = Role.USER;

  @ApiProperty({ description: 'State archive data', type: CreateStateArchiveDto })
  @ValidateNested()
