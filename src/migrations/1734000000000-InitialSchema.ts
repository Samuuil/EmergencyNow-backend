...
export class InitialSchema1734000000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "profiles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "height" integer NOT NULL, "weight" integer NOT NULL, "gender" "public"."profiles_gender_enum" NOT NULL, "allergies" text array, CONSTRAINT "PK_8e520eb4da7dc01d0e190447c8e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "ambulances" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "licensePlate" character varying NOT NULL, "vehicleModel" character varying, "latitude" double precision, "longitude" double precision, "available" boolean NOT NULL DEFAULT true, "driverId" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_5cc0009e6dc15590597dee5fd50" UNIQUE ("licensePlate"), CONSTRAINT "PK_27dcd0371aa8372b2e451ec596c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "calls" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" character varying NOT NULL, "latitude" double precision NOT NULL, "longitude" double precision NOT NULL, "status" "public"."calls_status_enum" NOT NULL DEFAULT 'pending', "routePolyline" text, "estimatedDistance" integer, "estimatedDuration" integer, "routeSteps" json, "ambulanceCurrentLatitude" double precision, "ambulanceCurrentLongitude" double precision, "dispatchedAt" TIMESTAMP, "arrivedAt" TIMESTAMP, "completedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "ambulanceId" uuid, CONSTRAINT "PK_d9171d91f8dd1a649659f1b6a20" PRIMARY KEY ("id"))`);
