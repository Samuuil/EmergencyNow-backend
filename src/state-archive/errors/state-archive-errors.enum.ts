...
export const StateArchiveErrorMessages: Record<StateArchiveErrorCode, string> =
  {
    [StateArchiveErrorCode.STATE_ARCHIVE_NOT_FOUND]:
      'State archive record not found',
    [StateArchiveErrorCode.STATE_ARCHIVE_ALREADY_EXISTS]:
      'State archive record already exists',
    [StateArchiveErrorCode.STATE_ARCHIVE_CREATION_FAILED]:
      'Failed to create state archive record',
    [StateArchiveErrorCode.STATE_ARCHIVE_UPDATE_FAILED]:
      'Failed to update state archive record',
    [StateArchiveErrorCode.STATE_ARCHIVE_DELETE_FAILED]:
      'Failed to delete state archive record',
    ...
    [StateArchiveErrorCode.EGN_ALREADY_EXISTS]:
      'EGN already exists in state archive',
